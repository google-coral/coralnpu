...
def locate_bison_data_root(files):
    ...
    if parent == file.path:
        fail("Unable to locate data directory from: {}".format(file.owner))
...
verilator_astgen = rule(
    ...
    attrs = {
        "args": attr.string_list(
            doc = "The command line arguments for `astgen`.",
        ),
        "astgen": attr.label(
        ...
        "_process_wrapper": attr.label(
            cfg = "exec",
            executable = True,
            default = Label("@coralnpu_hw//third_party/verilator:verilator_astgen"),
        ),
    },
)
...
verilator_bisonpre = rule(
    ...
    attrs = {
        ...
        "_process_wrapper": attr.label(
            executable = True,
            cfg = "exec",
            default = Label("@coralnpu_hw//third_party/verilator:verilator_bisonpre"),
        ),
    },
)
...
verilator_flexfix = rule(
    ...
    attrs = {
        "args": attr.string_list(
            doc = "The command line arguments for `flexfix`.",
        ),
        "flexfix": attr.label(
        ...
        "_process_wrapper": attr.label(
            cfg = "exec",
            executable = True,
            default = Label("@coralnpu_hw//third_party/verilator:verilator_flexfix"),
        ),
    },
)
...
verilator_version = rule(
    ...
    attrs = {
        ...
        "_parser": attr.label(
            executable = True,
            cfg = "exec",
            default = Label("@coralnpu_hw//third_party/verilator:verilator_version"),
        ),
    },
)
...
verilator_build_template = rule(
    ...
    attrs = {
        ...
        "_generator": attr.label(
            executable = True,
            cfg = "exec",
            default = Label("@coralnpu_hw//third_party/verilator:verilator_build_template"),
        ),
    },
)
