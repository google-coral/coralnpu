...
object FloatInstruction {
  def table(p: Parameters): Seq[(String, BitPat)] = {
    val fBase = Seq(
      "flw"       -> BitPat("b????????????_?????_010_?????_0000111"),
      "fsw"       -> BitPat("b???????_?????_?????_010_?????_0100111"),
      "fmadd.s"   -> BitPat("b?????_00_?????_?????_???_?????_1000011"),
      "fmsub.s"   -> BitPat("b?????_00_?????_?????_???_?????_1000111"),
      "fnmsub.s"  -> BitPat("b?????_00_?????_?????_???_?????_1001011"),
      "fnmadd.s"  -> BitPat("b?????_00_?????_?????_???_?????_1001111"),
      "fadd.s"    -> BitPat("b0000000_?????_?????_???_?????_1010011"),
      "fsub.s"    -> BitPat("b0000100_?????_?????_???_?????_1010011"),
      "fmul.s"    -> BitPat("b0001000_?????_?????_???_?????_1010011"),
      "fdiv.s"    -> BitPat("b0001100_?????_?????_???_?????_1010011"),
      "fsqrt.s"   -> BitPat("b0101100_00000_?????_???_?????_1010011"),
      "fsgnj.s"   -> BitPat("b0010000_?????_?????_000_?????_1010011"),
      "fsgnjn.s"  -> BitPat("b0010000_?????_?????_001_?????_1010011"),
      "fsgnjx.s"  -> BitPat("b0010000_?????_?????_010_?????_1010011"),
      "fmin.s"    -> BitPat("b0010100_?????_?????_000_?????_1010011"),
      "fmax.s"    -> BitPat("b0010100_?????_?????_001_?????_1010011"),
      "fcvt.w.s"  -> BitPat("b1100000_00000_?????_???_?????_1010011"),
      "fcvt.wu.s" -> BitPat("b1100000_00001_?????_???_?????_1010011"),
      "fmv.x.w"   -> BitPat("b1110000_00000_?????_000_?????_1010011"),
      "fclass.s"  -> BitPat("b1110000_00000_?????_001_?????_1010011"),
      "feq.s"     -> BitPat("b1010000_?????_?????_010_?????_1010011"),
      "flt.s"     -> BitPat("b1010000_?????_?????_001_?????_1010011"),
      "fle.s"     -> BitPat("b1010000_?????_?????_000_?????_1010011"),
      "fcvt.s.w"  -> BitPat("b1101000_00000_?????_???_?????_1010011"),
      "fcvt.s.wu" -> BitPat("b1101000_00001_?????_???_?????_1010011"),
      "fmv.w.x"   -> BitPat("b1111000_00000_?????_000_?????_1010011")
    )
    fBase
  }
