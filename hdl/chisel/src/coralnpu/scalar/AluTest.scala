  ...
  "ALU Operations" in {
    simulate(new Alu(p)) { dut =>
      ...
      // Sign Extend Byte
      {
        ...
        test_unary_op(dut, 13.U, AluOp.SEXTB, test_cases)
      }
      ...
      // Sign Extend Half Word
      {
        ...
        test_unary_op(dut, 13.U, AluOp.SEXTH, test_cases)
      }
      ...
      // Zero Extend Half Word
      {
        ...
        test_unary_op(dut, 13.U, AluOp.ZEXTH, test_cases)
      }
      ...
      // CLZ
      {
        ...
        test_unary_op(dut, 13.U, AluOp.CLZ, test_cases)
      }
      ...
      // CTZ
      {
        ...
        test_unary_op(dut, 13.U, AluOp.CTZ, test_cases)
      }
      ...
      // CPOP
      {
        ...
        test_unary_op(dut, 13.U, AluOp.CPOP, test_cases)
      }
      ...
      // ORCB
      {
        ...
        test_unary_op(dut, 13.U, AluOp.ORCB, test_cases)
      }
      ...
      // REV8
      {
        ...
        test_unary_op(dut, 13.U, AluOp.REV8, test_cases)
      }
      ...
      // XNOR(Not XOR)
      {
        ...
        testBinaryOp(dut, 13.U, AluOp.XNOR, test_cases)
      }
      ...
      // ORN(Not OR)
      {
        ...
        testBinaryOp(dut, 13.U, AluOp.ORN, test_cases)
      }
      ...
      // ANDN(Not AND)
      {
        ...
        testBinaryOp(dut, 13.U, AluOp.ANDN, test_cases)
      }
      ...
      // MAX
      {
        ...
        testBinaryOp(dut, 13.U, AluOp.MAX, test_cases)
      }
      ...
      // MAXU
      {
        ...
        testBinaryOp(dut, 13.U, AluOp.MAXU, test_cases)
      }
      ...
      // MIN
      {
        ...
        testBinaryOp(dut, 13.U, AluOp.MIN, test_cases)
      }
      ...
      // MINU
      {
        ...
        testBinaryOp(dut, 13.U, AluOp.MINU, test_cases)
      }
      ...
      // ROL
      {
        ...
        testBinaryOp(dut, 13.U, AluOp.ROL, test_cases)
      }
      ...
      // ROR
      {
        ...
        testBinaryOp(dut, 13.U, AluOp.ROR, test_cases)
      }
    }
  }
}
  ...
  "ALU 64-bit Operations" in {
    simulate(new Alu(p)) { dut =>
      // ADDW
      {
        ...
        testBinaryOp(dut, 13.U, AluOp.ADDW, inputs)
      }
      ...
      // SUBW
      {
        ...
        testBinaryOp(dut, 13.U, AluOp.SUBW, inputs)
      }
      ...
      // SLLW
      {
        ...
        testBinaryOp(dut, 13.U, AluOp.SLLW, inputs)
      }
      ...
      // SRLW
      {
        ...
        testBinaryOp(dut, 13.U, AluOp.SRLW, inputs)
      }
      ...
      // SRAW
      {
        ...
        testBinaryOp(dut, 13.U, AluOp.SRAW, inputs)
      }
      ...
      // CLZW
      {
        ...
        test_unary_op(dut, 13.U, AluOp.CLZW, test_cases)
      }
      ...
      // CTZW
      {
        ...
        val test_cases = base_cases.map { case (rs1, exp) => (rs1, BigInt(exp)) }
        test_unary_op(dut, 13.U, AluOp.CTZW, test_cases)
      }
      ...
      // CPOPW
      {
        ...
        val test_cases = base_cases.map { case (rs1, exp) => (rs1, BigInt(exp)) }
        test_unary_op(dut, 13.U, AluOp.CPOPW, test_cases)
      }
      ...
      // ROLW
      {
        ...
        testBinaryOp(dut, 13.U, AluOp.ROLW, inputs)
      }
      ...
      // RORW
      {
        ...
        testBinaryOp(dut, 13.U, AluOp.RORW, inputs)
      }
    }
  }
}
